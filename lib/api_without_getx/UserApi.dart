...
import 'package:flutter_use_by_getx/api_without_getx/nextmodel.dart';
                ...
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Id: ${samplePosts[index].name}',
                        style: TextStyle(fontSize: 18),
                      ),
                      Text(
                        'Title: ${samplePosts[index].email}',
                        style: TextStyle(fontSize: 18),
                      ),
                      Text(
                        'Body: ${samplePosts[index].address.city},${samplePosts[index].address.street},${samplePosts[index].address.zipcode},${samplePosts[index].address.geo}',
                        style: TextStyle(fontSize: 18),
                      ),
                    ],
                  ),
